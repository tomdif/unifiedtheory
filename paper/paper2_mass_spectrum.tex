...
The Higgs mass-to-VEV ratio $m_H/v = 0.42 \pm 0.05$
...
of magnitude are reported; all seven are within a factor of
...
predictions in the scorecard.  All seven predictions are within a
factor of $1.5\times$ of experiment.
The Cabibbo angle is within $1.3\sigma$ of experiment.
The Higgs mass-to-VEV ratio is within 18\% of experiment.
The $m_t/m_b$ ratio, previously the largest outlier at $7.2\times$,
is now $63.5$ vs.\ experiment $60$--$90$ (factor $0.85\times$) after
including the Casimir and hypercharge corrections (Section~9).
These seven
...
The $m_t/m_b$ ratio (corrected from the earlier $295$ to $63.5$;
see Section~9) now matches the Planck-scale experimental range
$60$--$90$ to within 15\%, using the Casimir and hypercharge
corrections derived from the gauge group.
...
$0.056 \pm 0.009$ at $\rho = 10{,}000$ with $\beta = 4$.  The
per-link proper time $\langle\tau\rangle \approx 0.283$ is
density-independent (measured at $\rho = 5$K, $10$K, $20$K),
confirming that the SU(2) coupling requires no density-dependent
correction.  The drift at higher densities ($0.067$ at $\rho = 20$K,
$0.083$ at $\rho = 50$K) is attributed to the chain-length
distribution extending to longer chains, a finite-size effect.

% ============================================================
% 8. THE m_t/m_b RATIO: CORRECTED
% ============================================================
...
\medskip
\noindent\textbf{Correction from earlier versions.}
The previously reported value $m_t/m_b = 295$ (factor $7.2\times$)
used $c_K/c_P$, the ratio of K-sector to P-sector projections.  This
is incorrect: $c_K/c_P$ measures the color-to-dressing ratio, not the
up-to-down weak projection.  The base value $m_t/m_b = 18$ (the
inverse of $m_\mu/m_\tau$) captures the weak SU(2) projection but
omits the color and hypercharge corrections.  The full formula
including the Casimir ratio and hypercharge ratio gives $63.5$,
...
Each factor is a theorem of the framework:
\begin{itemize}[nosep]
  \item $1/r_{\mu\tau} = 17.9$: computed from the SU(2) holonomy
    on Poisson causal sets (Section~4).
  \item $C_2(\mathrm{SU}(3))/C_2(\mathrm{SU}(2)) = 16/9$: the
    quadratic Casimir invariants of the derived gauge group
    (Paper~I).
  \item $|Y(t_R)/Y(b_R)| = 2$: the hypercharges determined by
    anomaly cancellation (Paper~I, Theorem~\ref{thm:electron}).
\end{itemize}
