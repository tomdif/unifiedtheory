...
17 files, $\sim$4{,}000 lines, zero \texttt{sorry} statements, zero
...
\noindent\textit{Lean verification: 17 files, $\sim$4{,}000 lines,
...
of a locally finite partial order to the thirteen capstone properties
...
Input reduction (5$\to$1) & Lean~4 & Zero sorry (17 files) \\
