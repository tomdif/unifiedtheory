...
- prove the real high-density BDG/RNC profile limits generated by the physical
  causal-growth law and sample them along the recovered-stage density sequence;
...
4. Gate 4: instantiate `BDGProfileSequenceAsymptotics.profile_tendsto` from
   interval-volume/RNC estimates for the physical causal-growth law.
