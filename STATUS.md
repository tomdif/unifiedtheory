...
> response dynamics, and elementary complement symmetry, plus obtaining
...
causal-growth postulates or the minimal local response principle.
...
one minimal local response principle listed above.
...
880 Lean files in `UnifiedTheory/`, **zero sorry and zero custom axioms** in
core mathematical content. Latest full root build: 8,634 jobs successful
(July 2026).
