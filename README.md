...
convergence plus exact-recovery certificates.  It now also packages explicit
partial-closure certificates for Gate 4's recovered-stage 4D BDG operator bridge and strongest
scheduled kernel/operator bridge, Gate 5's local Born/projective completeness
and finite Hopf carrier cover-independence layers, and Gate 6's dark-density
and cosmological-constant/graviton-mode audits, and proves Gate 7 protocol
closure from the preregistration ledger. Full Gates 4-6 remain open until their
missing physical, infrared, cosmological, and black-hole inputs are derived;
...
- horizon-invisible geometric relaxation: the oriented protected source is now
  ...
  setoid and the Bloch coordinates descend to it; the normalized quotient
  ...
  algebraic normalized phase quotient is bijective at set level; the inverse
  module packages that bijection as a map from unit Bloch coordinates back to
  normalized phase classes; the recovered-stage Hopf fiber interface now lifts
