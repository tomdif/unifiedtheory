...
convergence certificates.  It now also exposes Gate 4's recovered-stage 4D BDG
operator hook, Gate 5's finite Hopf carrier cover-independence hook, Gate 6's
dark-density audit hook, and a Gate 7 protocol-closure proof from the
preregistration ledger. Full Gates 4-6 remain open until their missing
physical, infrared, cosmological, and black-hole inputs are derived; Gate 7
